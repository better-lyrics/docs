...
> Free API for syllable-synced song lyrics. Base URL: https://api.betterlyrics.org. Main endpoint: GET /getLyrics?s={song}&a={artist}&al={album}&d={durationSeconds}, which returns TTML. Alternative providers: /qq/getLyrics (QRC) and /kugou/getLyrics (LRC). Cached songs need no API key.
